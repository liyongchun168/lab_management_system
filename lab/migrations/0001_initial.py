...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('status', models.IntegerField(choices=[(0, '\u4e0d\u901a\u8fc7'), (1, '\u7b49\u5f85'), (2, '\u901a\u8fc7')])),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('users', models.ManyToManyField(related_name='join_project', through='lab.ProApprove', to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
                'ordering': ['-date'],
